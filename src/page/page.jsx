...
export function SizeFitPage({ navigate }) {
  ...
  useDocumentHead({
    ...
    description: "Learn how Urban Eye measures frame size — lens width, bridge width, and temple length — so you can find eyeglasses and sunglasses that fit your face perfectly.",
  });

  const sizeChartImage = isMobile ? "/content/size-chart-mob.jpeg" : "/content/size-chart.jpeg";

  return (
    <div style={{ minHeight: "100vh", background: "#FAFAF8", fontFamily: ff }}>
      <h1 style={srOnly}>Size &amp; Fit Guide | Urban Eye</h1>
      <PageBanner image="/assets/banners/banner3.png" alt="Urban Eye — Size & Fit" overlayText="SIZE & FIT" />

      <Breadcrumb crumbs={[{ label: "HOME", path: "/" }, { label: "SIZE & FIT", path: null }]} />
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: isMobile ? "48px 20px" : "80px 40px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: isMobile ? 28 : 56, alignItems: "center" }}>
          <FadeIn>
            <div style={{ background: CREAM, border: "1px solid #e8e0d0", display: "flex", justifyContent: "center", padding: isMobile ? 12 : 20 }}>
              <img
                src={sizeChartImage}
                alt="How Urban Eye measures frame size — bridge width, temple length, lens width"
                loading="eager"
                decoding="async"
          ...
          <FadeIn delay={80}>
            <div>
              <p style={{ fontFamily: mono, fontSize: isMobile ? 13 : 14, lineHeight: 1.9, color: "#444", margin: "0 0 20px" }}>
                Size matters. We determine size by the width of your face. With over 25 years of optical
                expertise, we know not every frame fits every face — that's why Urban Eye offers multiple
                sizes so you can find the right frame for your face.
              </p>
              <p style={{ fontFamily: mono, fontSize: isMobile ? 13 : 14, lineHeight: 1.9, color: "#444", margin: "0 0 28px" }}>
