...
// //             </p>
// //             <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
// //               {/* <YBtn onClick={() => navigate("#/")}>{slide.cta}</YBtn> */}
// //               <button onClick={() => goTo("#/products")} style={{ background: BRAND, color: "#fff", border: "none", padding: "12px 24px", fontSize: 15, cursor: "pointer" }}>
// //                 SHOP NOW
// //               </button>
// //               <OutlineBtn dark={!!slide.dark}>{slide.ctaSecond} →</OutlineBtn>
// //             </div>
...
// //           {/* Right column — intentionally empty now. The hero background
// //               image (with the real eyeglass products) shows through here.
// //               The decorative black glasses SVG + pulse circle + "EST. 2015"
// //               label that used to sit here has been removed. */}
// //           <div />
// //         </div>
...
// <Section id="size" title="SIZE">
//   {[
//     { label: "Small", values: ["44 (Narrow)", "45"] },
//     { label: "Medium", values: ["46 (Average)", "47", "48"] },
//     { label: "Large", values: ["49 (Wide)", "52 (Extra Wide)"] },
//   ].map(({ label, values }) => {
//     const count = allProducts.filter((product) =>
//       (product.sizes || []).some((s) => values.includes(s))
//     ).length;
//     return (
//       <Check
//         key={label}
//         group="size"
//         value={label}               // This will be stored in activeFilters.size
//         label={label}
//         count={count}
//       />
//     );
